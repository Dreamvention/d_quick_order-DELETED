...
class ModelExtensionModuleDQuickOrder extends Model
{
    ...
    public function createOptionsByProductIdAndOrderId($data)
    {
        return $this->db->query("INSERT INTO " . DB_PREFIX . "$this->tableOrderOption SET
        quick_order_id = '" . (int)$data['quick_order_id'] . "',
        product_to_order_id = '" . (int)$data['product_to_order_id'] . "',
    ...
    public function deleteOptionsByProductIdAndOrderId($product_id, $order_id)
    {
        return $this->db->query("DELETE FROM " . DB_PREFIX . "$this->tableOrderOption WHERE product_to_order_id = '" . (int)$product_id . "' AND quick_order_id = '" . (int)$order_id . "'");
    }
